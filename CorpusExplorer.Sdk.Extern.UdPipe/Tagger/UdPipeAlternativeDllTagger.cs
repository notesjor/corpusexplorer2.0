...
{
  public class UdPipeAlternativeDllTagger : AbstractConllStyleTagger
  {
    private string _languageSelected;
    private Model.Model _model;

    public UdPipeAlternativeDllTagger()
    {
    ...
    public override string DisplayName => "UDPipe (Alternative Modelle)";
