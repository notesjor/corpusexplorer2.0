...
{
  public class Words : IDisposable, IEnumerable
    , IEnumerable<Word>
  {
    ...
    {
      IntPtr cPtr = udpipe_csharpPINVOKE.Words_GetRange(swigCPtr, index, count);
      Words ret = cPtr == IntPtr.Zero ? null : new Words(cPtr, true);
      if (udpipe_csharpPINVOKE.SWIGPendingException.Pending) throw udpipe_csharpPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
    ...
    {
      IntPtr cPtr = udpipe_csharpPINVOKE.Words_Repeat(Word.getCPtr(value), count);
      Words ret = cPtr == IntPtr.Zero ? null : new Words(cPtr, true);
      if (udpipe_csharpPINVOKE.SWIGPendingException.Pending) throw udpipe_csharpPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
    ...
    public sealed class WordsEnumerator : IEnumerator
      , IEnumerator<Word>
    {
