...
namespace CorpusExplorer.Sdk.Extern.Json.TwitterStream.Model
{
  public class StreamMessage
  {
    ...
    */
    ...
    [JsonProperty("coordinates")] public Geo Coordinates { get; set; }

    [JsonProperty("created_at")] public string CreatedAt { get; set; }

    [JsonProperty("entities")] public Entities Entities { get; set; }

    [JsonProperty("extended_entities")] public ExtendedEntities ExtendedEntities { get; set; }
    ...
    [JsonProperty("retweeted_status")] public StreamMessage RetweetedStatus { get; set; }

    [JsonProperty("source")] public string Source { get; set; }

    [JsonProperty("text")] public string Text { get; set; }

    [JsonProperty("timestamp_ms")] public string TimestampMs { get; set; }
