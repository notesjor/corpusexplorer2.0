...
namespace CorpusExplorer.Sdk.Extern.Json.TwitterStream.Model
{
  public class User
  {
    ...
    [JsonProperty("favourites_count")] public ulong FavouritesCount { get; set; }
    ...
    */
    ...
    [JsonProperty("followers_count")] public ulong FollowersCount { get; set; }
    ...
    */
    ...
    [JsonProperty("friends_count")] public ulong FriendsCount { get; set; }
    ...
    [JsonProperty("is_translator")] public bool IsTranslator { get; set; }

    [JsonProperty("lang")] public string Lang { get; set; }

    [JsonProperty("listed_count")] public ulong ListedCount { get; set; }
    ...
    */
    ...
    [JsonProperty("statuses_count")] public ulong StatusesCount { get; set; }
