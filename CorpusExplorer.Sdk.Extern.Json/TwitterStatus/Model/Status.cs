...
namespace CorpusExplorer.Sdk.Extern.Json.TwitterStatus.Model
{
  public class Status
  {
    ...
    [JsonProperty("Coordinates")] public object Coordinates { get; set; }
    ...
    [JsonProperty("Entities")] public object Entities { get; set; }

    [JsonProperty("ExcludeReplies")] public bool ExcludeReplies { get; set; }

    [JsonProperty("ExtendedEntities")] public object ExtendedEntities { get; set; }
    ...
    [JsonProperty("MaxID")] public ulong MaxID { get; set; }
    ...
    [JsonProperty("Place")] public object Place { get; set; }

    [JsonProperty("PossiblySensitive")] public bool PossiblySensitive { get; set; }

    [JsonProperty("QuotedStatus")] public object QuotedStatus { get; set; }
    ...
    [JsonProperty("RetweetedStatus")] public object RetweetedStatus { get; set; }

    [JsonProperty("Scopes")] public object Scopes { get; set; }
