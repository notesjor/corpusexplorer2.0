...
namespace CorpusExplorer.Sdk.Extern.Xml.SlashA
{
  ...
  {
    public override string DisplayName { get { return "Slash/A-XML"; } }

    protected override AbstractGenericSerializer<DSpin> Serializer { get { return new SlashASerializer(); } }
