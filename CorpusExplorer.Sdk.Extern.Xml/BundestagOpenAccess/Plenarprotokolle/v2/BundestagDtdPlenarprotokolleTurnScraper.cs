...
{
  public class BundestagDtdPlenarprotokolleTurnScraper : AbstractHtmlScraper
  {
    public override string DisplayName { get; } = "Bundestag Plenarprotokolle (DTD ab Wahlperiode 19 - separate Sprecher*innen)";
