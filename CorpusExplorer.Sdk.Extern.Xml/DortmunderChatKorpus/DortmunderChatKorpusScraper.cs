...
namespace CorpusExplorer.Sdk.Extern.Xml.DortmunderChatKorpus
{
  ...
  {
    public override string DisplayName { get { return "Dortmunder Chat Korpus"; } }

    protected override AbstractGenericSerializer<logfile> Serializer
    {
      get { return new DortmunderChatKorpusSerializer(); }
    }

    protected override IEnumerable<Dictionary<string, object>> ScrapDocuments(logfile model)
    {
      return
        model.body.Select(
               message =>
