...
namespace CorpusExplorer.Sdk.Extern.Xml.Folker.Flk.Extension
{
  ...
  public static class WExtension
  {
    ...
    public static IEnumerable<stress> GetAllStress(this w w)
    {
      return w.Items.OfType<stress>().Select(o => o);
    }

    public static IEnumerable<time> GetAllTimes(this w w)
    {
      return w.Items.OfType<time>().Select(o => o);
    }
  }
}