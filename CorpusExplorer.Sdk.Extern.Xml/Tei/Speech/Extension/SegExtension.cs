...
namespace CorpusExplorer.Sdk.Extern.Xml.Tei.Speech.Extension
{
  ...
  {
    public static IEnumerable<anchor> GetAllAnchors(this seg seg) { return seg.Items.OfType<anchor>().Select(o => o); }

    public static IEnumerable<string> GetAllCs(this seg seg) { return seg.Items.OfType<string>().Select(o => o); }
    ...
    public static IEnumerable<pause> GetAllPauses(this seg seg) { return seg.Items.OfType<pause>().Select(o => o); }
    ...
    public static IEnumerable<w> GetAllWs(this seg seg) { return seg.Items.OfType<w>().Select(o => o); }
  }
}