...
using CorpusExplorer.Sdk.Extern.NHunspell.Blocks;
using CorpusExplorer.Sdk.ViewModel.Abstract;
using CorpusExplorer.Sdk.ViewModel.Interfaces;

namespace CorpusExplorer.Sdk.Extern.NHunspell.ViewModel
{
#if UNIVERSAL
#else
  public class ReadingEaseViewModel : AbstractViewModel, IProvideDataTable
  {
    ...
    public DataTable GetDataTable()
    {
      ...
      res.Columns.Add("Index", typeof(string));
    ...
    public DataTable GetDataTableSimple()
    {
      var res = new DataTable();
      res.Columns.Add("Index", typeof(string));
      res.Columns.Add("Dokument (GUID)", typeof(string));
      res.Columns.Add("Wert", typeof(double));
