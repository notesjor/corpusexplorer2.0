...
namespace CorpusExplorer.Terminal.WinForm.View.StyleMetrics
{
  ...
  /// </summary>
  public partial class CompareBasedOnCooccurrences : AbstractView
  {
    private ClusterMetadataByCooccurenceViewModel _vm;

    /// <summary>
    ///   Initializes a new instance of the <see cref="AbstractView" /> class.
    /// </summary>
    public CompareBasedOnCooccurrences()
    {
      InitializeComponent();
    }
    ...
    private void ResetNodes()
    {
      ...
      {
        _vm.CooccurrenceMinFrequency = 5;
        _vm.CooccurrenceMinSignificance = 1;
        _vm.Execute();
    ...
    {
      _vm = GetViewModel<ClusterMetadataByCooccurenceViewModel>();
