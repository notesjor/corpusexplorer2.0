...
namespace CorpusExplorer.Terminal.WinForm.View.Cooccurrence
{
  ...
  /// </summary>
  public partial class CompareCooccurrence : AbstractGridView
  {
    private DataTable _table;
    private CooccurrenceCompareViewModel _vm;

    /// <summary>
    ///   Initializes a new instance of the <see cref="AbstractView" /> class.
    /// </summary>
    public CompareCooccurrence()
    {
      InitializeComponent();
    ...
    {
      QueryBuilderFunction(Resources.Kookkurrenz + "_" + Resources.Vergleich);
    }
    ...
    {
      _vm = ViewModelGet<CooccurrenceCompareViewModel>();
