namespace CorpusExplorer.Terminal.WinForm.View.Cooccurrence
{
  partial class CooccurrenceGrid
  {
    ...
    private void InitializeComponent()
    {
      ...
      // btn_posFilter
      // 
      this.btn_posFilter.DisplayName = "commandBarToggleButton1";
      ...
      this.btn_posFilter.Text = "POS-Filter";
      ...
      this.txt_query.NullText = "Begriff hier eingeben, um die Tabelle beidseitig zu filtern...";
