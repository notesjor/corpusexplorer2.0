...
using CorpusExplorer.Sdk.Extern.FuzzyCloneDetection.Action;
...
namespace CorpusExplorer.Sdk.Extern.FuzzyCloneDetection
{
  public class AddonRepository : AbstractAddonRepository
  {
    public override string Guid => "CorpusExplorer.Sdk.Extern.FuzzyCloneDetection";
