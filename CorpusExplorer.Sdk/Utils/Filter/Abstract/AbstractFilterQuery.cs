...
namespace CorpusExplorer.Sdk.Utils.Filter.Abstract
{
  ...
  [XmlInclude(typeof(FilterQueryDocumentGuid))]
  ...
  [XmlInclude(typeof(FilterQueryMultiLayerComplex))]
  [XmlInclude(typeof(FilterQueryMultiLayerPhrase))]
  [XmlInclude(typeof(FilterQuerySingleLayerAFollowedByBMatch))]
  [XmlInclude(typeof(FilterQuerySingleLayerAFollowedByBSpanMatch))]
  ...
  [XmlInclude(typeof(FilterQuerySingleLayerExists))]
  [XmlInclude(typeof(FilterQuerySingleLayerFirstAndAnyOtherMatch))]
  [XmlInclude(typeof(FilterQuerySingleLayerFirstFollowedByAnyOtherMatch))]
  [XmlInclude(typeof(FilterQuerySingleLayerMarkedPhrase))]
  [XmlInclude(typeof(FilterQuerySingleLayerRanked))]
  [XmlInclude(typeof(FilterQuerySingleLayerRegex))]
