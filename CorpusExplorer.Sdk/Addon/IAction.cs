...
namespace CorpusExplorer.Sdk.Addon
{
  public interface IAction
  {
    ...
    /// <param name="args">
    ///   Argumente/Parameter die über die Konsole oder ein Skript bereitgestellt werden. Es werden nur
    ///   relevante Parameter übergeben ([INPUT]/[QUERY] werden gefltert)
    /// </param>
    /// <param name="writer">
    ///   Das gewünschte Ausgabeformat. Die Ausgabe der ACTION sollte eine DataTable sein, die mit
    ///   writer.WriteTable(
    /// </param>
    /// <example>
