...
namespace CorpusExplorer.Sdk.Blocks.SelectionCluster.Cluster.Helper
{
  public static class ClusterToSelectionHelper
  {
    public static Selection ToSelection(this AbstractCluster cluster, Project project, Selection selection) 
      => selection == null ? project.SelectAll.Create(cluster.DocumentGuids, cluster.Displayname, true) : selection.Create(cluster.DocumentGuids, cluster.Displayname, false);

    public static IEnumerable<Selection> ToSelection(this IEnumerable<AbstractCluster> clusters, Project project, Selection selection) 
