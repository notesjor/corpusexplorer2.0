...
namespace CorpusExplorer.Sdk.Blocks.GroupDocuments
{
  ...
  public class GroupDocumentsCompareDateTime : AbstractGroupDocumentsComparer
  {
    ...
    public override bool IsBiggerOrEqual(object obj, object refernce) { return (DateTime) obj >= (DateTime) refernce; }

    public override bool IsSmallerOrEqual(object obj, object refernce) { return (DateTime) obj <= (DateTime) refernce; }
