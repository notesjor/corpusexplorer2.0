...
{
  public class ClusterMetadataByCooccurenceSelectiveViewModel : AbstractViewModel, IProvideDataTable
  {
    private ClusterMetadataByCooccurrenceSelectiveBlock _block;
