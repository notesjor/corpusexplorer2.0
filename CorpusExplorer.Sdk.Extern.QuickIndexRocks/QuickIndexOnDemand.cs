...
namespace CorpusExplorer.Sdk.Extern.QuickIndexRocks
{
  ...
  /// Index wird immer nur dann geladen wenn nötig.
  /// Vorteil: Minimiert RAM-Footprint
  /// Nachteil: Länge Latenz
  /// Implements the <see cref="System.IDisposable" />
  /// </summary>
  /// <seealso cref="System.IDisposable" />
  public class QuickIndexOnDemand : IDisposable
  {
    ...
    public QuickIndexOnDemand(string pathToCec6, string layerDisplayname = "Wort")
    {
    ...
    {
      var dicRes = DictionaryIndex.ReadDicRes(_pathToCec6, _layerDisplayname);
    ...
    public Dictionary<long, HashSet<int>> Search(string query)
    {
      try
      {
        var _meta = InverseIndex.Read(_pathToCec6, _layerDisplayname);
        var _dic = DictionaryIndex.ReadDic(_pathToCec6, _layerDisplayname);
