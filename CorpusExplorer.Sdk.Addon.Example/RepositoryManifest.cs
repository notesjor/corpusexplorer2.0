...
namespace CorpusExplorer.Sdk.Addon.Example
{
  public class RepositoryManifest : AbstractAddonRepository
  {
    ...
    /// </summary>
    public override IEnumerable<IAddonView> AddonViews =>
      new IAddonView[]
      {
        new DisplayValuesView(),
    ...
    /// </summary>
    public override string Guid => "CorpusExplorer.Sdk.Addon.Example";
  }
}