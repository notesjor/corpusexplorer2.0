...
// Code is generated on: 15.09.2018 16:39:50
//
...
namespace CorpusExplorer.Sdk.Db.MySQL.Model
{

    [DatabaseAttribute(Name = "corpusexplorer")]
...
namespace CorpusExplorer.Sdk.Db.MySQL.Model
{
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySQL.Model.Corpus in the schema.
    /// </summary>
    [Table(Name = @"d14.Corpora")]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySQL.Model.CorpusMetadataEntry in the schema.
    /// </summary>
    [Table(Name = @"d14.CorpusMetadataEntries")]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySQL.Model.Layer in the schema.
    /// </summary>
    [Table(Name = @"d14.Layers")]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySQL.Model.LayerDictionaryEntry in the schema.
    /// </summary>
    [Table(Name = @"d14.LayerDictionaryEntries")]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySQL.Model.Document in the schema.
    /// </summary>
    [Table(Name = @"d14.Documents")]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySQL.Model.LayerDocument in the schema.
    /// </summary>
    [Table(Name = @"d14.LayerDocuments")]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySQL.Model.DocumentMetadataEntry in the schema.
    /// </summary>
    [Table(Name = @"d14.DocumentMetadataEntries")]
