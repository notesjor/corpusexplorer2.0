...
// Code is generated on: 16.06.2019 17:07:49
//
...
namespace CorpusExplorer.Sdk.Db.MySql.Model.Full
{

    [DatabaseAttribute(Name = "ce")]
...
namespace CorpusExplorer.Sdk.Db.MySql.Model.Full
{
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.Corpus in the schema.
    /// </summary>
    [Table(Name = @"Corpora")]
    public partial class Corpus : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnCreated();
        partial void OnIDChanging(ushort value);
        ...
        /// </summary>
        [Column(Storage = "_ID", CanBeNull = false, DbType = "smallint(5) UNSIGNED NOT NULL", IsPrimaryKey = true)]
        public ushort ID
        {
            get
            {
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.CorpusMetadata in the schema.
    /// </summary>
    ...
    public partial class CorpusMetadata : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnValidate(ChangeAction action);
        partial void OnCreated();
        partial void OnCorpusIDChanging(ushort value);
        ...
        /// </summary>
        [Column(Storage = "_CorpusID", CanBeNull = false, DbType = "smallint(5) UNSIGNED NOT NULL", IsPrimaryKey = true)]
        public ushort CorpusID
        {
            get
            {
        ...
        /// </summary>
        [Column(Storage = "_Label", CanBeNull = false, DbType = "VARCHAR(200) NOT NULL", IsPrimaryKey = true)]
        public string Label
        {
            get
            {
        ...
        /// </summary>
        [Column(Storage = "_Value", DbType = "longtext NULL", UpdateCheck = UpdateCheck.Never)]
        public string Value
        {
            get
            {
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.Document in the schema.
    /// </summary>
    ...
    public partial class Document : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for CorpusID in the schema.
        /// </summary>
        [Column(Storage = "_CorpusID", CanBeNull = false, DbType = "smallint(5) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public ushort CorpusID
        {
            get
            {
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.DocumentMetadata in the schema.
    /// </summary>
    ...
    public partial class DocumentMetadata : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnValidate(ChangeAction action);
        partial void OnCreated();
        partial void OnDocumentIDChanging(uint value);
        ...
        /// </summary>
        [Column(Storage = "_DocumentID", CanBeNull = false, DbType = "int(9) UNSIGNED NOT NULL", IsPrimaryKey = true)]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.Token in the schema.
    /// </summary>
    [Table(Name = @"Tokens")]
    public partial class Token : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnDocumentIDChanging(uint value);
        partial void OnDocumentIDChanged();
        partial void OnTokenIndexChanging(uint value);
        ...
        /// There are no comments for ID in the schema.
        /// </summary>
        [Column(Storage = "_ID", CanBeNull = false, DbType = "bigint(18) UNSIGNED NOT NULL", IsPrimaryKey = true)]
        public ulong ID
        {
            get
            {
        ...
        /// There are no comments for DocumentID in the schema.
        /// </summary>
        [Column(Storage = "_DocumentID", CanBeNull = false, DbType = "int(9) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public uint DocumentID
        {
            get
            {
        ...
        /// </summary>
        [Column(Storage = "_TokenIndex", CanBeNull = false, DbType = "int(9) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.Annotation in the schema.
    /// </summary>
    ...
    public partial class Annotation : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnLayerValueIDChanging(uint value);
        ...
        /// </summary>
        [Column(Storage = "_TokenID", CanBeNull = false, DbType = "bigint(18) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_LayerValueID", CanBeNull = false, DbType = "int(9) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public uint LayerValueID
        {
            get
            {
        ...
        public LayerValue LayerValue
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._LayerValue.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._LayerValueID = default(uint);
                    }
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.Layer in the schema.
    /// </summary>
    [Table(Name = @"Layers")]
    public partial class Layer : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for Displayname in the schema.
        /// </summary>
        [Column(Storage = "_Displayname", CanBeNull = false, DbType = "longtext NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public string Displayname
        {
            get
            {
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.LayerValue in the schema.
    /// </summary>
    ...
    public partial class LayerValue : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnIDChanging(uint value);
        partial void OnIDChanged();
        partial void OnLayerIDChanging(uint value);
        ...
        /// </summary>
        [Column(Storage = "_LayerID", CanBeNull = false, DbType = "int(9) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public uint LayerID
        {
            get
            {
    ...
    /// <summary>
    /// There are no comments for CorpusExplorer.Sdk.Db.MySql.Model.Full.AnnotationSpan in the schema.
    /// </summary>
    ...
    public partial class AnnotationSpan : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_TokenStartID", CanBeNull = false, DbType = "bigint(18) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_TokenEndID", CanBeNull = false, DbType = "bigint(18) UNSIGNED NOT NULL", UpdateCheck = UpdateCheck.Never)]
