...
namespace CorpusExplorer.Sdk.Extern.Plaintext.WET.Forms
{
  public partial class LanguageSelectionForm : AbstractForm
  {
    ...
    private void btn_ok_Click(object sender, EventArgs e)
    {
      ...
      {
        MessageBox.Show("Bitte wählen Sie zuerst eine Sprache aus!", "CorpusExplorer", MessageBoxButtons.OK,
      ...
      {
        MessageBox.Show(
          "Bitte trennen Sie Domains mittels Semikolon (;). Nur grün hinterlegte Domains werden gefiltert");
        return;
      }
