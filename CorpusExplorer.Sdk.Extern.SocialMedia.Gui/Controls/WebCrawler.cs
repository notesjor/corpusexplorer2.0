...
{
  public partial class WebCrawler : AbstractUserControl
  {
    ...
    public WebCrawler()
    {
      ...
      radWizard1.Cancel += (s, e) => Close(this, null);
    ...
    private void radWizard1_Finish(object sender, EventArgs e)
    {
      ...
      {
        MessageBox.Show("Sie benötigen mindestens ein Mapping mit dem Key: Text");
        return;
      }
