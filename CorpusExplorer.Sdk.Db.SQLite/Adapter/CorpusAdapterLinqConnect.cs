...
using CorpusExplorer.Sdk.Db.Sqlite.Model.DataContext;
using CorpusExplorer.Sdk.Model;
using CorpusExplorer.Sdk.Model.Adapter.Corpus.Abstract;
using CorpusExplorer.Sdk.Model.Adapter.Layer.Abstract;
using CorpusExplorer.Sdk.Utils.DocumentProcessing.Abstract;
using Devart.Data.Linq;
using Corpus = CorpusExplorer.Sdk.Db.Sqlite.Model.DataContext.Corpus;
using DataContext = CorpusExplorer.Sdk.Db.Sqlite.Model.DataContext.DataContext;
using Layer = CorpusExplorer.Sdk.Db.Sqlite.Model.DataContext.Layer;

#endregion

namespace CorpusExplorer.Sdk.Db.SQLite.Adapter
{
