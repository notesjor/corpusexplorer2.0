...
using System.Linq;
using CorpusExplorer.Sdk.Db.SQLite.Model.FullAccess;
...
using Corpus = CorpusExplorer.Sdk.Db.SQLite.Model.FullAccess.Corpus;
using Layer = CorpusExplorer.Sdk.Db.SQLite.Model.FullAccess.Layer;

#endregion

namespace CorpusExplorer.Sdk.Db.SQLite.Exporter
{
  public class ExporterFullAccess : AbstractExporter
  {
